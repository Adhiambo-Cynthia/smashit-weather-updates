...
const { country, city } = document.forms.location_form.element;
console.log(city);
console.log(country);

function getData(city, country) {
  fetch(
    `https://api.openweathermap.org/data/2.5/weather?q=${city},${country}&APPID=9df8c0407c102e47b33df91715eda0aa`
  )
    .then((res) => res.json())
    .then((data) => {
      console.log(data);
